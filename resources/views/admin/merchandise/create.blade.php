...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mb-3">
    <h3>merchandise create(Show the form for creating a new resource)</h3>
    <h5>GET|HEAD| admin/merchandise/{parent_id}/create|| App\Http\Controllers\Admin\MerchandiseController@create| web,auth</h5>
